...
namespace Shop.Web.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await this.CheckUserAsync("margarita@gmail.com", "Margie", "Pit", "Customer");
            await this.CheckUserAsync("angelina@gmail.com", "Angelina", "Jolie", "Customer");
            var user = await this.CheckUserAsync("mariitza@gmail.com", "Laura", "Restrepo", "Admin");

            // Add products
            if (!this.context.Products.Any())
            {
                this.AddProduct("AirPods", 159, user);
                this.AddProduct("Mouse", 1199, user);
                this.AddProduct("HP Pavilion Laptop", 799, user);
                this.AddProduct("iMac", 1398, user);
                this.AddProduct("Iphone 7", 749, user);
